package ita.tinybite.domain.auth.kakao;

import com.fasterxml.jackson.annotation.JsonProperty;
import ita.tinybite.domain.auth.dto.response.KakaoAuthToken;
import ita.tinybite.domain.auth.dto.response.KakaoTokenResponse;
